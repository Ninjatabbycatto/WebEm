    ...
    <div id="leftPanel">
        ...
        <a class="regularpanel clickable-panel" id = "homeButton" href="{{ route('workplace.index')}}" >
        ...
        <a class="regularpanel clickable-panel" id = "employeesButton" href="{{ route('workplace.Employees')}}">
        ...
        <a class="regularpanel clickable-panel" id = "workplaceButton" href="{{ route('workplace.Workplace')}}">
            <svg  xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 26 26"  width="2.5vw" height="2.5vw">
        ...
        <a class="regularpanel clickable-panel" id = "calendarButton" href="{{ route('workplace.Calendar')}}">
        ...
        <a class="regularpanel clickable-panel" id = "notesButton" href="{{ route('workplace.Notes')}}">
            <svg  xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 22 22"  width="2.5vw" height="2.5vw">
        ...
        <a class="regularpanel clickable-panel" id = "bulletinButton" href="{{ route('workplace.Bulletin')}}">
