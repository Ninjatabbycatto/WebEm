<x-layout>
    ...
    <div class = "rightPanelRectangle">
        ...
        <div class = "rowContainer2">
            @if ($newNote == 1) 
            <div class='titleContainer'>
                <div><input type="text" class="transparent-textbox roboto-black" placeholder="Title"></div>
            ...
            <div class='actualNote'>
                <textarea class="transparent-textfield roboto-meduium" placeholder="Enter text here...">
                </textarea>
            </div>
